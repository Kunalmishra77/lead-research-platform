...
## Tasks
- [ ] 2.1 Finalize `research-spec.schema.json` v1 + industry taxonomy seed (top ~300 categories incl. Indian SMB categories) + geo seed (Indian states/cities with bounding boxes; extendable)
...
- [ ] 2.5 Credit estimation service and ledger operations: grant (signup bonus), reserve, consume, release; 402 handling
...
- [ ] 2.12 Web: New Research page (prompt box, examples, SpecChips edit, feasibility badges, depth selector, estimate, run); Research job page (stage progress, counters, credits, streaming basic table); history page
